  ...
  class Data {
    ...
    static const Map<String, String> prayers = {
      ...
      'Pésame': 'Yo confiezo ante Dios Todopoderoso y ante ustedes hermanos que he pecado mucho, de pensamiento, palabra, obra y omisión. Por mi culpa, por mi culpa, por mi gran culpa. Por eso ruego a Santa María siempre Virgen, a los ángeles, a los Santos y a ustedes hermanos, que intercedan por mí ante Dios Nuestro Señor Jesucristo. Amén.',
    ...
    //TODO: agregar otra capa donde ponga cada elemeto que va a ser parte del rosario
     ...
     static const List<RosaryDetailCircle> rosaryDetailsCircle = [
      ...
      RosaryDetailCircle(cuenta: 'rosa', count: 1, order: 2,
          ...
          , prayers:[ 'Gloria','Oh Jesús Mío','María Madre de Gracia','Misterio','Padre Nuestro']),
     ...
     static const List<RosaryDetailExtension> rosaryDetailsExtension = [
      RosaryDetailExtension(cuenta: 'rosa', count: 1,  order: 6,
          width: 'medium', height: 'medium'
          , prayers:[ 'Gloria','Oh Jesús Mío','María Madre de Gracia','Intenciones del Papa','Padre Nuestro']),
